# Generated by Django 4.1 on 2023-01-28 10:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='admins.articlecategories')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('meta_tags', models.JSONField(blank=True, null=True, verbose_name='Meta tags')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nbm', models.CharField(blank=True, max_length=13, null=True, validators=[admins.models.telephone_validator], verbose_name='Номер телефона')),
