...
urlpatterns = [
    ...
    path("article/delete", user_passes_test(lambda u: u.is_superuser,
         login_url='login_admin')(views.del_article), name='del_article'),
    ...
    path("translation/delete", user_passes_test(lambda u: u.is_superuser,
    ...
    path("about_us", user_passes_test(lambda u: u.is_superuser,
         login_url='login_admin')(views.AboutUsView.as_view()), name='about_us'),
    ...
    path('car_makes', user_passes_test(lambda u: u.is_superuser, login_url='login_admin')(
        views.CarMarkList.as_view()), name='car_makes_list'),
    path("car_makes/create", user_passes_test(lambda u: u.is_superuser,
         login_url='login_admin')(views.CarMarkCreate.as_view()), name='car_makes_create'),
    path("car_makes/<int:pk>/edit", user_passes_test(lambda u: u.is_superuser,
         login_url='login_admin')(views.CarMarkEdit.as_view()), name='car_makes_edit'),
    path('car_models', user_passes_test(lambda u: u.is_superuser,
         login_url='login_admin')(views.CarsModelList.as_view()), name='car_models'),
    path("car_models/create", user_passes_test(lambda u: u.is_superuser,
         login_url='login_admin')(views.CarModelCreate.as_view()), name='car_models_create'),
    path("car_models/<int:pk>/edit", user_passes_test(lambda u: u.is_superuser,
         login_url='login_admin')(views.CarModelEdit.as_view()), name="car_models_edit"),
    path("city", user_passes_test(lambda u: u.is_superuser,
         login_url='login_admin')(views.CityList.as_view()), name='city_list'),
    path('city/create', user_passes_test(lambda u: u.is_superuser,
    ...
    path('states/create', user_passes_test(lambda u: u.is_superuser,
         login_url='login_admin')(views.StatesCreate.as_view()), name='states_create'),
    path('states/<int:pk>/edit', user_passes_test(lambda u: u.is_superuser,
         login_url='login_admin')(views.StatesEdit.as_view()), name='state_edit'),
